...
<body>
    <div class="nav">
        ...
        <div class="">
            <?php if ($isAdmin): ?>
                <a href='add.php?kohort=2022' class='add-btn'>Add +</a>
            <?php endif; ?>
        ...
        <tbody>
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if ($isAdmin) {
                        echo "<td>
                                <a href='edit.php?id={$row['ic']}&kohort=2022' class='btn edit'>Edit</a>
                                <a href='delete.php?id={$row['ic']}&kohort=2022' class='btn delete' onclick='return confirm(\"Padam data ini?\")'>Delete</a>
                              </td>";
                    }
